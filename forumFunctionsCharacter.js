...
function createArrayChoice(choiceName,buttonText,placeholderText,isNested=false,canHaveDC=false){
  ...
  input.setAttribute("title",`character ${choiceName}`);
...
function createDualInformation(overallElementName,elementName1,elementName2,buttonText,placeholderText1,placeholderText2,buttonType1,buttonType2,canHaveDC=false,needSaveType=false,canBeAnAura=false,hasUniqueTrait=false,canHaveDamage=false){
  ...
  AName.setAttribute("title",`character ${overallElementName}`);
  if(buttonType2==="text"){
  ...
  ADetails.setAttribute("title",`character ${overallElementName}`);
  if(canHaveDC){
    var saveDCCheckLabel = document.createElement("p");
    saveDCCheckLabel.setAttribute("class","inputName");
    saveDCCheckLabel.textContent = "Has Save DC";
...
function createAttackInformation(overallElementName,placeholderText1,placeholderText2){
  ...
  CAName.setAttribute("title",`character ${overallElementName}`);
  ...
  ADice.setAttribute("title",`character ${overallElementName}`);
  ...
  toHitModifier.setAttribute("title",`character ${overallElementName}`);
...
//      console.log(`enchantment${overallElementName}${i}`);
      ...
      for(let j=enchantList.length-1;j>=0;j--){
        ...
        enchantElement.querySelector(`#enchantment${overallElementName}${i}${j}`).title=`character enchantment${overallElementName}${(i-1)}${j}`;
...
function reset(){
  ...
  document.getElementById("characterSpellModInnate").value="Int";
    document.getElementById("characterSpellModPrepared").value="Int";
  ...
  document.getElementById("characterName").value = "Mimic";
  document.getElementById("characterRace")[0].selected=true;
  document.getElementById("customType").value="";
  document.getElementById("characterTitle").value = "Mimic";
  document.getElementById("characterCR")[7].selected=true;
  document.getElementById("characterLevel").value="7";
  document.getElementById("characterHitDice")[2].selected = true;
  document.getElementById("characterSetHP").value="";
  document.getElementById("characterSetHD").value="";
  document.getElementById("characterSpeed").value = "30";
  document.getElementById("characterFort")[1].selected = true;
  document.getElementById("characterRef")[1].selected = true;
  document.getElementById("characterWill")[0].selected = true;
  document.getElementById("characterAlignment")[4].selected=true;
  document.getElementById("characterStr").value="19";
  document.getElementById("characterDex").value="12";
  document.getElementById("characterCon").value="17";
  document.getElementById("characterInt").value="10";
  document.getElementById("characterWis").value="13";
  document.getElementById("characterCha").value="10";
  document.getElementById("characterBaB").value="Medium";
  document.getElementById("characterSkillProgression").value="Middle";
  document.getElementById("characterSize")[4].selected = true;
  ...
  textBoxes = ['characterSetHP','characterSetHD','atWill','constant','weakness','gear','special_attacks','HPTraits','space','reach_bonus_effects','reach','SR','Resist','Immune','DR','DA','natural','shield','dodge','deflection','ConcentratePrepared','CLPrepared','ConcentrateInnate','CLInnate'];
  textBoxes.forEach(elements=>{
    ...
    case "5e":
      ...
      let elements;
      document.getElementById("characterName").value = "Mimic";
      document.getElementById("characterRace").value = "Aberration(shapechanger)";
      document.getElementById("characterTitle").value = "Mimic";
      document.getElementById("characterCR").value="4";
      document.getElementById("characterXP").value="1200";
      document.getElementById("characterLevel").value="7";
      document.getElementById("characterSpeed").value = "30";
      document.getElementById("characterAlignment").value="N";
      document.getElementById("characterStr").value="19";
      document.getElementById("characterDex").value="12";
      document.getElementById("characterCon").value="17";
      document.getElementById("characterInt").value="10";
      document.getElementById("characterWis").value="13";
      document.getElementById("characterCha").value="10";
      document.getElementById("characterSize")[2].selected = true;
 ...
 * @param {string} sys 
 */
function resetEdit(characterInfo,sys){
  reset();
  readJsonData(characterInfo,sys);
}
 ...
 * @param {json} cinfo 
 */
function createCharacterJson(cinfo){
  ...
  let type = document.getElementById("characterRace").value;
  ...
  let title = document.getElementById("characterTitle").value;
  let cr = document.getElementById("characterCR").value;
  let lvl = document.getElementById("characterLevel").value;
  let hitDice = document.getElementById("characterHitDice").value
  let rate = document.getElementById("characterHitDiceRate").value
  let setHP = document.getElementById("characterSetHP").value
  let setHD = document.getElementById("characterSetHD").value
  let speed = document.getElementById("characterSpeed").value;

  let hpTraits ="";
  if(document.getElementById("HPTraits")!=''){
    hpTraits = document.getElementById("HPTraits").value;
  }
  let fort = document.getElementById("characterFort").value;
  let ref = document.getElementById("characterRef").value;
  let will = document.getElementById("characterWill").value;
  let alignment = document.getElementById("characterAlignment").value;
  //ac
  let armor = 0;
  let deflection = 0;
  let dodge = 0;
...
//defense
  ...
  innateJson["casterMod"]=document.getElementById("characterSpellModInnate").value;
  }
  if(hasPrepared){
  ...
  prepared["casterMod"]=document.getElementById("characterSpellModPrepared").value;
}
}
  let extra = [];  
...
//  let melee = document.getElementById("melee").value;
  ...
  let size = document.getElementById("characterSize").value;
  let str = document.getElementById("characterStr").value;
  let dex = document.getElementById("characterDex").value;
  let con = document.getElementById("characterCon").value;
  let int = document.getElementById("characterInt").value;
  let wis = document.getElementById("characterWis").value;
  let cha = document.getElementById("characterCha").value;
  let bab = document.getElementById("characterBaB").value;
  ...
  let skillProgression = document.getElementById("characterSkillProgression").value;
...
//  populateData(extra,'extra');
  ...
  let sizeMod =getCharacterSizeMod(size);
...
//  let modifiedCMD =""
  ...
  if(specialAbility.length>0){
    ...
    case "5e":
      ...
      let ability = [];
      let action = [];
      let cname5e = document.getElementById("characterName").value;
      let type5e = document.getElementById("characterRace").value;
      let cr5e = document.getElementById("characterCR").value;
      let xp5e = document.getElementById("characterXP").value;
      let lvl5e = document.getElementById("characterLevel").value;
      let ac5e = document.getElementById("ac").value;
      let hd5e = document.getElementById("characterHitDice").value;
      let speed5e = document.getElementById("characterSpeed").value;
      let size5e = document.getElementById("characterSize").value;
      let str5e = document.getElementById("characterStr").value;
      let dex5e = document.getElementById("characterDex").value;
      let con5e = document.getElementById("characterCon").value;
      let int5e = document.getElementById("characterInt").value;
      let wis5e = document.getElementById("characterWis").value;
      let cha5e = document.getElementById("characterCha").value;
      let proficiency = document.getElementById("characterProficiency").value;
      let alignment5e = document.getElementById("characterAlignment").value;
      let sense5e = document.getElementById("characterSense").value;
...
//  console.log(skillList);
  ...
  for(let skill of skillList){
    ...
    let intModifier = getModifier(document.getElementById("characterInt").value);
    if(intModifier!="-"){
      if(intModifier<1){
        intModifier=1;
      }
    switch(skillProgression){
      case "Low":
        availableSkillPoints = (2+intModifier)*Number(document.getElementById("characterLevel").value);
        break;
      case "Middle":
        availableSkillPoints = (4+intModifier)*Number(document.getElementById("characterLevel").value);
        break;
      case "High":
        availableSkillPoints = (6+intModifier)*Number(document.getElementById("characterLevel").value);
        break;
      default:
        break;
    }
...
function createFormListeners(skillList){
  ...
  createListeners("characterSkillProgression","click",refreshList);
  createListeners("characterInt","input",refreshList);
  createListeners("characterLevel",'input',refreshList);
  createListeners("featButton",'click',refreshList);
}


function setFeatsAvailable(){
  let feats = Math.floor((Number(document.getElementById("characterLevel").value)-1)/2)+1;
...
function characterRaceListener(){
 ...
 switch (characterRace.value) {
  case "Aberration":
      document.getElementById("characterHitDice")[2].selected = true;
      document.getElementById("characterBaB")[1].selected = true;
      document.getElementById("characterSkillProgression")[1].selected = true;
      document.getElementById("characterFort")[1].selected = true;
      document.getElementById("characterRef")[1].selected = true;
      document.getElementById("characterWill")[0].selected = true;
      resetSkills();
  ...
  case "Animal":
      ...
      document.getElementById("characterBaB")[1].selected = true;
      document.getElementById("characterSkillProgression")[1].selected = true;
      document.getElementById("characterFort")[0].selected = true;
      document.getElementById("characterRef")[0].selected = true;
      document.getElementById("characterWill")[1].selected = true;
      resetSkills();
      document.getElementById("skillsOption").checked = true;
    ...
    break;
    case "Construct":
      document.getElementById("characterHitDice")[3].selected = true;
      document.getElementById("characterBaB")[2].selected = true;
      document.getElementById("characterSkillProgression")[2].selected = true;
      document.getElementById("characterFort")[1].selected = true;
      document.getElementById("characterRef")[1].selected = true;
      document.getElementById("characterWill")[1].selected = true;
      resetSkills();
    break;
    case "Dragon":
      document.getElementById("characterHitDice")[4].selected = true;
      document.getElementById("characterBaB")[0].selected = true;
      document.getElementById("characterSkillProgression")[0].selected = true;
      document.getElementById("characterFort")[0].selected = true;
      document.getElementById("characterRef")[0].selected = true;
      document.getElementById("characterWill")[0].selected = true;
      resetSkills();
    ...
    break;
    case "Fey":
      document.getElementById("characterHitDice")[1].selected = true;
      document.getElementById("characterBaB")[0].selected = true;
      document.getElementById("characterSkillProgression")[0].selected = true;
      document.getElementById("characterFort")[1].selected = true;
      document.getElementById("characterRef")[0].selected = true;
